...
input_file = "data/CureRite/visitation_services_export.csv"

# Path to save the output CSV file
output_file = "data/cleaned_data_files/visitations_services_cleaned.csv"
parquet_output_file_path = "data/cleaned_data_files/visitations_services_cleaned.parquet"
# Columns to remove from the data frame
columns_to_remove = [
    "created_at",
]

process_csv_file(input_file, output_file, parquet_output_file_path, columns_to_remove)
